import { s as setContext, c as create_ssr_component, e as escape, b as add_attribute, d as compute_slots, f as add_styles, v as validate_component } from "../../../chunks/ssr.js";
import { w as writable } from "../../../chunks/index2.js";
import { i as initializeDrawerStore, D as Drawer } from "../../../chunks/Drawer.js";
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  initializeStores();
  return `${validate_component(Drawer, "Drawer").$$render($$result, {}, {}, {})} ${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    header: () => {
      return `${validate_component(AppBar, "AppBar").$$render($$result, {}, {}, {
        trail: () => {
          return `<a class="btn btn-sm variant-ghost-surface"${add_attribute("href", config.discord, 0)} target="_blank" rel="noreferrer" data-svelte-h="svelte-r918wn">Discord</a> <a class="btn btn-sm variant-ghost-surface"${add_attribute("href", config.developer, 0)} target="_blank" rel="noreferrer" data-svelte-h="svelte-1xr10np">Developer</a> <a class="btn btn-sm variant-ghost-surface"${add_attribute("href", config.github, 0)} target="_blank" rel="noreferrer" data-svelte-h="svelte-jsqej5">GitHub</a> `;
        },
        lead: () => {
          return `<a href="/" data-svelte-h="svelte-whjvc8"><img${add_attribute("src", config.logo, 0)} alt="${escape(config.title, true) + " Logo"}"></a> `;
        },
        default: () => {
          return `<a href="/"><strong class="text-xl">${escape(config.title)}</strong></a> <div class="h-1"></div>`;
        }
      })} `;
    },
    default: () => {
